...
function Products() {
  return (
    <div id='products' className='products'>
      <Container>
        <div data-aos-duration="1000" data-aos="fade-right" className='products__logo'>
          <img src={productLogo} alt="" />
        </div>
        <ul className='products__list'>
          <li data-aos-duration="1000"  data-aos="fade-down-right" className='card1'>
            <img src={card1} alt="" />
          ...
          <li data-aos-duration="1000"  data-aos="fade-up" className='card2'>
            <img src={card2} alt="" />
            <h5>IT Services</h5>
          ...
          <li data-aos-duration="1000"  data-aos="fade-down-left" className='card3'>
            <img src={card3} alt="" />
